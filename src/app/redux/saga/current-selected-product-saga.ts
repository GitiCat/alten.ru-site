...
interface ISetProductAction extends Action, ISetProductTypes {
	type: typeof UPDATE_PRODUCT
}
interface ISetCategoryProductAction extends Action, ISetCategoryProductTypes {
	type: typeof UPDATE_PRODUCT_CATEGORY_ID
}
interface ISetProductItemAction extends Action, ISetProductItemTypes {
	type: typeof UPDATE_PRODUCT_ITEM_ID
}
...
function* setProduct(action: ISetProductTypes) {
	...
	yield put({ type: SET_PRODUCT, payload })
}
